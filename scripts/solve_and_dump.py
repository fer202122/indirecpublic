...
def main():
    ...
    if a.mode == "true_anomaly":
        prob = TransferProblem_TrueAnomaly(a.r0, a.mu, a.omega, a.a0, np.radians(a.raan), np.radians(a.inc), np.radians(a.arglat), a.theta_f * 2.0 * np.pi)
        grid = np.linspace(0.0, 1.0, a.samples)
    else:
        prob = TransferProblem_Time(a.r0, a.mu, a.omega, a.a0, np.radians(a.raan), np.radians(a.inc), np.radians(a.arglat), a.time_f * 24.0 * 3600.0)
        grid = np.linspace(0.0, 1.0, a.samples)
